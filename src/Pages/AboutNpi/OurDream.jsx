import allImage from "../../assets/Imges/AboutNpi/all.jpg"; // Adjust this path based on your project structure
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-gray-900">Our Dream</h2>
